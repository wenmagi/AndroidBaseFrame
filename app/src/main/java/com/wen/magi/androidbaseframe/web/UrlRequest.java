...
import com.wen.magi.androidbaseframe.volley.DefaultRetryPolicy;
...
import static com.wen.magi.androidbaseframe.utils.WebUtils.compositeUrl;
import static com.wen.magi.androidbaseframe.utils.WebUtils.createURL;
import static com.wen.magi.androidbaseframe.volley.Request.Method.GET;
import static com.wen.magi.androidbaseframe.volley.Request.Method.POST;
...
public class UrlRequest {
    ...
    public void start(boolean immediate) {
        ...
        requestPriority.setPriority(immediate ? com.wen.magi.androidbaseframe.volley.Request.Priority.IMMEDIATE : com.wen.magi.androidbaseframe.volley.Request.Priority.NORMAL);
